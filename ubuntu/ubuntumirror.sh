...
#
section=main,restricted,universe,multiverse,main/debian-installer,main/dist-upgrader-all
...
#
release=lucid,lucid-security,lucid-updates,natty,natty-security,natty-updates,oneiric,oneiric-security,oneiric-updates,precise,precise-security,precise-updates,precise-backports
...
#
outPath=/repo1/ubuntumirror/up-to-date
